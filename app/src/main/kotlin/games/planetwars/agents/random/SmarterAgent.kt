...
// private val ForwardModel.gameState: GameState
...
class SmarterAgent(
    ...
    private fun evaluateMove(source: Planet, target: Planet): Double {
        ...
        val effectiveShips = max(1.0, target.nShips) // max(1.0, source.nShips / 2.0).toDouble()
    ...
    override fun getAgentType(): String =
        "SmarterAgent4:PopRHEA+Greedy+Elitism"
